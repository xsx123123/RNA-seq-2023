...
# cutadapt
for each in ./3.rm_adapter/*.R1.fastq.gz
do
...
cutadapt -j 15 \
         ...
         -u 15 \
         -U 15 \
         -o ./4.rm_15bp/$file_name.R1.fastq.gz \
         -p ./4.rm_15bp/$file_name.R2.fastq.gz \
         ./3.rm_adapter/$file_name.R1.fastq.gz \
         ./3.rm_adapter/$file_name.R2.fastq.gz
done
# 单端测序参数
